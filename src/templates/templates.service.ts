...
export class TemplatesService {
    ...
    if(filecontent && filecontent._id)
    {
        ...
        {
            let filedata:any= await this.updateFileContent(deletePath,user.filepath,templateDto.template)
    ...
    async getTemplateData(id:any)
    {
        ...
        let content:any=await this.readtheFile("./src/mail/templates/"+template.filepath+".hbs");
    ...
    async updateFileContent(delete_file,filepath,content)
    {
        ...
        fs.writeFile("./src/mail/templates/"+filepath+".hbs",content, function (err,data) {
    ...
    async createnewTemplate(templateDto:CreateTemplateDto,req:any)
    {
        ...
        return await newUser.save().then((user) => {
            ...
            fs.writeFile("./src/mail/templates/"+name+".hbs",templateDto.template, function (err) {
