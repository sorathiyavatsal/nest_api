...
export class SettlementsController {
    ...
    async postDownloadCSV(@Request() request, @Res() res) {
        ...
        const data = [
            {
                ID: 1,
                Date: "Angel",
                Hours: "https://byecom.in/_next/image?url=%2Fbyecom-logo.png&w=256&q=75",
                Distance: "Angel",
                Earning_Balance: "https://byecom.in/_next/image?url=%2Fbyecom-logo.png&w=256&q=75",
            },
            {
                ID: 1,
                Date: "Angel",
        ...
        return await this.SettlementsService.downloadResource(res, 'result.csv', fields, data);
    }
}
