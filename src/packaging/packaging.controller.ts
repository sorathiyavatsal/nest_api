...
export class PackagingsController {
  ...
  @Post('/add-Packagings')
  async addPackagings(
    @Body() createPackagingsDto: CreatePackagingsDto,
    @Request() request,
  ) {
    return await this.Packagingservice.createPackagings(
      createPackagingsDto,
      request.user,
    );
  }
  ...
  async updatePackagings(
    @Param() params,
    @Body() editPackagingsDto: EditPackagingsDto,
    @Request() request: any,
  ) {
    return await this.Packagingservice.updatePackagings(
      params.id,
      editPackagingsDto,
      request.user,
    );
